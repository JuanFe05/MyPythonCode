...
try:
    ...
    """Ordena de mayor a menor, dependiendo de la suma total de las aptitudes"""
    # nuevoResultado = sorted(resultado, key=itemgetter(1), reverse=True)
    # # print(nuevoResultado)
    # for i in range(len(nuevoResultado)):
    #      for j in range(len(nuevoResultado[i])):
    #          print(nuevoResultado[i][j], end=' ')
    #      print()
