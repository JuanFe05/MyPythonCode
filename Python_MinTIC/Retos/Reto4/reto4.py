...
temperaturas = [[int(j) for j in input().split()] for i in range(n_zonas)]
profundidades = [[int(j) for j in input().split()] for i in range(n_zonas)]
...
for i in range(len(temperaturas)):
    ...
    conteoZonas.append([nA, mgA, mdA, sA])
...
print(nada_apto, marginalmente_apto, moderadamente_apto, sumamente_apto)
print((','.join(mayorF)))
print((','.join(menorF)))