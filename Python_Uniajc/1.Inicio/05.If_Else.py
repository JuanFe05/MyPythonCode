...
if numeroGrande == 123456:
    ...
    print("El número:", numeroGrande, "es menor a 123456")
...
elif nombre1 == "Juan" or nombre2 == "Jorge" or nombre3 == "Camila":
    print("Solo un nombre es correcto")

else:
    print("Ningun nombre es correcto") """